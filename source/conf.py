# -*- coding: utf-8 -*-
#
# lomse documentation build configuration file, created by
...
latex_documents = [
  ('index', 'lomse.tex', u'lomse Documentation',
   u'Lomse project', 'manual'),
]
...
man_pages = [
    ('index', 'lomse', u'lomse Documentation',
     [u'Lomse project'], 1)
]
